...
RUN_NAME="caring_fixed_robotics_study${VIEW_SUFFIX}"
LOG_DIR="${NEW_ROOT}/training-runs/caring/${RUN_NAME}"
...
cp -f "${CODE_DIR}/lib/caring.py" "${SRC_SNAPSHOT_DIR}/lib/caring.py"
cp -f "${CODE_DIR}/train_caring.py" "${SRC_SNAPSHOT_DIR}/train_caring.py"
