...
RUN_NAME="tdrl_fixed_robotics_kitchen${VIEW_SUFFIX}"
CKPT_PATH="${CKPT_PATH:-${NEW_ROOT}/training-runs/tdrl/${RUN_NAME}/checkpoints/vae_epoch${EPOCH}.pth}"
LOG_PATH="${LOG_PATH:-${NEW_ROOT}/training-runs/tdrl/${RUN_NAME}_eval_${REPR_MODE}.log}"
