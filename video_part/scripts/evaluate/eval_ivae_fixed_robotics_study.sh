...
CKPT_PATH="${CKPT_PATH:-${NEW_ROOT}/training-runs/ivae/ivae_fixed_robotics_study/checkpoints/ivae_epoch${EPOCH}.pth}"
LOG_PATH="${LOG_PATH:-${NEW_ROOT}/training-runs/ivae/ivae_fixed_robotics_study_eval_${REPR_MODE}.log}"
