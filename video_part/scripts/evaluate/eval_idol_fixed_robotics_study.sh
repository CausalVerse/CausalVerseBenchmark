...
RUN_NAME="idol_fixed_robotics_study${VIEW_SUFFIX}"
CKPT_PATH="${CKPT_PATH:-${NEW_ROOT}/training-runs/idol/${RUN_NAME}/checkpoints/vae_epoch${EPOCH}.pth}"
LOG_PATH="${LOG_PATH:-${NEW_ROOT}/training-runs/idol/${RUN_NAME}_eval_${REPR_MODE}.log}"
