...
CKPT_PATH="${CKPT_PATH:-${NEW_ROOT}/training-runs/caring/caring_fixed_robotics_kitchen/checkpoints/vae_epoch${EPOCH}.pth}"
LOG_PATH="${LOG_PATH:-${NEW_ROOT}/training-runs/caring/caring_fixed_robotics_kitchen_eval_${REPR_MODE}.log}"
